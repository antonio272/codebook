...
@section('content')
    ...
    <div class="row d-flex mt-5" >
        ...
        <div class="col-md-3" style="background: linear-gradient(0deg, rgba(255,255,255,1) 2%, rgba(255,255,255,1) 6%, rgba(247,247,247,1) 24%, rgba(70,137,173,1) 100%, rgba(177,191,193,1) 100%, rgba(150,202,223,1) 100%, rgba(12,149,244,1) 100%);">
            <div class="col-md-3 mt-3">
                <img src="{{ Auth::user()->profile->picture }}" alt="" class="rounded-circle"> 
            </div>
        </div>

        <div class="col-md-3 p-o"style="background: linear-gradient(0deg, rgba(255,255,255,1) 2%, rgba(255,255,255,1) 6%, rgba(247,247,247,1) 24%, rgba(70,137,173,1) 100%, rgba(177,191,193,1) 100%, rgba(150,202,223,1) 100%, rgba(12,149,244,1) 100%);">
