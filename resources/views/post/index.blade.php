...
@section('content')
    ...
    <div class="row d-flex mt-5 col-md-12" >
        <div class="col-md-3"></div>
        <div class="col-md-3" style="background: #D9DCDC;">
            <div class="col-md-3 my-3">
                <img src="{{ Auth::user()->profile->picture }}" alt="" class="rounded-circle"> 
            </div>
        </div>

        <div class="col-md-3 p-o"style="background: #D9DCDC;">
    ...
    <div class="row d-flex mt-2 col-md-12" style=""> 
    <div class="col-md-3"></div> 
            <!-- direcionar -->
    <div class="follows text-black col-sm-6" style="background: #ffffff"> 
    ...
    <div class="row d-flex mt-2 col-md-12"> 
    <div class="col-md-3"></div> 
            <!-- follow people -->
    <div class="follows text-black col-sm-6 border-top border-2  border-bottom border-2" style="background: #ffffff"> 
            <div class="pl-3 mt-3 ">
                <h5>
                    <strong>
                    <a href="/profile/{{auth()->user()->profile->user_id}}/following" style="text-decoration: none; color:black">
           ...
           <!-- @foreach ($usersugestion as $usersug)
            ...
            @foreach ($usersugestionuser as $usersuguser)
                ...
                <a href="/profile/{{ $usersuguser->profile->id }}" style="text-decoration: none; color:black">
                            ...
                            <strong>{{ $usersuguser->name }}</strong>
                            <!--<strong>
                            ...
                            @if ( $usersuguser->following->whereIn('user_id',Auth::user()->id)->pluck('user_id')->count() !=0)
                                <div class="h6"><strong>"Follows you!"</strong></div>
                                 ...
                                 <div class="h6"><strong>"Doesn't follow you!!"</strong></div>
                            @endif
                            <!--if !empty return 
        ...
        <div class="row">
            ...
            <div class="col-sm-6" style="background: #fff; margin: 10px 0px; padding: 5px 5px 5px 5px;border-radius: 5px;">
                <div class="mb-3" style="background: #fff; border-radius: 5px;">
                    ...
                    <like-button post-id="{{ $post->id }}" likes ="{{ (auth()->user()) ? auth()->user()->likeing->contains($post->id) : false }}"></like-button><!---->
                    ...
                    <dt class="col-sm-4 ml-2 text-align-center" style="width: fit-content; margin-left: 10px"><a style="text-decoration: none; color:black" href="/post/{{ $post->id }}">
                     {{$post->commentarios->count() +  $commentariosshowid->whereIn('commentario_id',$post->commentarios()->pluck('id'))->count() }} comments </a></dt>
                    </div>
